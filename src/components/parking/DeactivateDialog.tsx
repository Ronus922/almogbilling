...
// Confirmation for switching a spot/unit OFF — the only "removal" this module
// has. A Dialog is correct here per DESIGN.md §12: this is a destructive
// confirmation, not an entity edit (those are Sheets).
//
