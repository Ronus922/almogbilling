...
const GUARD = /require(Actor|Admin|SuperAdmin|Permission|AnyPermission|NotificationsAccess|AssistantAccess|CanManageRole|DriveConnector)|getCurrentActor|getSession|CRM_CRON_SECRET|BILLING_CRON_SECRET|GREEN_API_WEBHOOK_SECRET|GREENAPI_WEBHOOK_TOKEN/;
