...
-- supabase/migrations/034_notifications_clear.sql — do not edit; edit nothing, history is frozen.
-- migrate:up
...
-- migrate:down
-- no down migration was written for legacy 034_notifications_clear
