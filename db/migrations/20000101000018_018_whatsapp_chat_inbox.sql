...
-- supabase/migrations/018_whatsapp_chat_inbox.sql — do not edit; edit nothing, history is frozen.
...
-- migrate:down
-- no down migration was written for legacy 018_whatsapp_chat_inbox
