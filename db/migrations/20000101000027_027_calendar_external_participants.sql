...
-- supabase/migrations/027_calendar_external_participants.sql — do not edit; edit nothing, history is frozen.
-- migrate:up
...
-- migrate:down
-- no down migration was written for legacy 027_calendar_external_participants
