...
-- supabase/migrations/004_completed_actions.sql — do not edit; edit nothing, history is frozen.
-- migrate:up
...
-- migrate:down
-- no down migration was written for legacy 004_completed_actions
