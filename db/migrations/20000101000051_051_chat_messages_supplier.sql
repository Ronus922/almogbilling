...
-- supabase/migrations/051_chat_messages_supplier.sql — do not edit; edit nothing, history is frozen.
...
-- migrate:down
-- no down migration was written for legacy 051_chat_messages_supplier
