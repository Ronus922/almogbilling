...
-- supabase/migrations/055_backfill_recurrence_anchor.sql — do not edit; edit nothing, history is frozen.
...
-- migrate:down
-- no down migration was written for legacy 055_backfill_recurrence_anchor
