...
-- supabase/migrations/005_status_management.sql — do not edit; edit nothing, history is frozen.
...
-- migrate:down
-- no down migration was written for legacy 005_status_management
