...
-- supabase/migrations/033_notifications_fanout.sql — do not edit; edit nothing, history is frozen.
-- migrate:up
...
-- migrate:down
-- no down migration was written for legacy 033_notifications_fanout
