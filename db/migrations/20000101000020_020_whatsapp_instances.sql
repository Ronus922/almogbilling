...
-- supabase/migrations/020_whatsapp_instances.sql — do not edit; edit nothing, history is frozen.
...
-- migrate:down
-- no down migration was written for legacy 020_whatsapp_instances
