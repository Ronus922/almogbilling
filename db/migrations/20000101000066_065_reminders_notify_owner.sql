...
-- supabase/migrations/065_reminders_notify_owner.sql — do not edit; edit nothing, history is frozen.
-- migrate:up
...
-- migrate:down
-- no down migration was written for legacy 065_reminders_notify_owner
