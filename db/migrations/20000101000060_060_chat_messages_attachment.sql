...
-- supabase/migrations/060_chat_messages_attachment.sql — do not edit; edit nothing, history is frozen.
-- migrate:up
...
-- migrate:down
-- no down migration was written for legacy 060_chat_messages_attachment
