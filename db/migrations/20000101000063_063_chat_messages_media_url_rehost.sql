...
-- supabase/migrations/063_chat_messages_media_url_rehost.sql — do not edit; edit nothing, history is frozen.
...
-- migrate:down
-- no down migration was written for legacy 063_chat_messages_media_url_rehost
