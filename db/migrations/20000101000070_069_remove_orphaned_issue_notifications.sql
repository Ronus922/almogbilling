...
-- supabase/migrations/069_remove_orphaned_issue_notifications.sql — do not edit; edit nothing, history is frozen.
...
-- migrate:down
-- no down migration was written for legacy 069_remove_orphaned_issue_notifications
