...
-- supabase/migrations/032_reminder_categories.sql — do not edit; edit nothing, history is frozen.
...
-- migrate:down
-- no down migration was written for legacy 032_reminder_categories
