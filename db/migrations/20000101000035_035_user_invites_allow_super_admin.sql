...
-- supabase/migrations/035_user_invites_allow_super_admin.sql — do not edit; edit nothing, history is frozen.
-- migrate:up
...
-- migrate:down
-- no down migration was written for legacy 035_user_invites_allow_super_admin
