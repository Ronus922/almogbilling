...
-- supabase/migrations/008_simplify_permissions.sql — do not edit; edit nothing, history is frozen.
...
-- migrate:down
-- no down migration was written for legacy 008_simplify_permissions
