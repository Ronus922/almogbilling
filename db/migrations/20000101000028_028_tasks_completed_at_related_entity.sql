...
-- supabase/migrations/028_tasks_completed_at_related_entity.sql — do not edit; edit nothing, history is frozen.
-- migrate:up
...
-- migrate:down
-- no down migration was written for legacy 028_tasks_completed_at_related_entity
