...
-- supabase/migrations/016_supplier_categories.sql — do not edit; edit nothing, history is frozen.
...
-- migrate:down
-- no down migration was written for legacy 016_supplier_categories
