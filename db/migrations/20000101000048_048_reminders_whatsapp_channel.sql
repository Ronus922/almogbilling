...
-- supabase/migrations/048_reminders_whatsapp_channel.sql — do not edit; edit nothing, history is frozen.
-- migrate:up
...
-- migrate:down
-- no down migration was written for legacy 048_reminders_whatsapp_channel
